...
#output = forward_and_backward(f, sorted_nodes)
...
#sorted_nodes = topological_sort(feed_dict)
#mutiply_output = forward_and_backward(f2, sorted_nodes)
...
#linear_output = forward_and_backward(f, graph)
#print(linear_output)
...
#
#graph = topological_sort(feed_dict)
#output = forward_and_backward(f, graph)
#
...
#
#graph = topological_sort(feed_dict)
#output = forward_and_backward(g, graph)
#
...
#graph = topological_sort(feed_dict)
#
#forward_and_backward(cost, graph)
#
